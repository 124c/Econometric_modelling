...
def select_coint_rank(
    ...
    coint_result = coint_johansen_stationary(endog, det_order, k_ar_diff)
...
def coint_johansen_stationary(endog, det_order, k_ar_diff):
    """
    ...
    dx = endog #np.diff(endog, 1, axis=0)
